...
public class notas {
    public static void main(String[] args) {
        ...
        double[] promedios_array = new double[estudiantes_num]; //double[] funciona como un array donde podras almacenar muchos datos, un array basicamente
        ...
        for (int i = 1; i <= estudiantes_num; i++)
        {
            ...
            promedios_array[i - 1] = promedio;  //aqui invocamos el array promedio con un -1 para que empieze desde el número 0
            ...
            String estado; //declaramos estado como un string a invocar
            if (promedio >= 51)
                estado = "Aprobado";
            else if (promedio >= 40)
